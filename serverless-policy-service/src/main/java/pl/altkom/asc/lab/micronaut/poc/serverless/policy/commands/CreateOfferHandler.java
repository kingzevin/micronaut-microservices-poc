...
import pl.altkom.asc.lab.micronaut.poc.serverless.policy.domain.OfferFactory;
import pl.altkom.asc.lab.micronaut.poc.serverless.policy.domain.OfferRepository;
import pl.altkom.asc.lab.micronaut.poc.serverless.policy.infrastructure.adapters.restclient.PricingClient;
...
import pl.altkom.asc.lab.micronaut.poc.serverless.pricing.service.api.v1.commands.calculateprice.dto.ChoiceQuestionAnswer;
import pl.altkom.asc.lab.micronaut.poc.serverless.pricing.service.api.v1.commands.calculateprice.dto.NumericQuestionAnswer;
import pl.altkom.asc.lab.micronaut.poc.serverless.pricing.service.api.v1.commands.calculateprice.dto.QuestionAnswer;
import pl.altkom.asc.lab.micronaut.poc.serverless.pricing.service.api.v1.commands.calculateprice.dto.TextQuestionAnswer;
...
public class CreateOfferHandler implements CommandHandler<CreateOfferResult, CreateOfferCommand> {
    ...
    public CreateOfferResult handle(CreateOfferCommand cmd) {
        ...
        System.out.println("xiaoshabi");
        System.out.println(offer.getNumber());
    ...
    private List<QuestionAnswer> constructAnswers(List<pl.altkom.asc.lab.micronaut.poc.serverless.policy.service.api.v1.commands.createoffer.dto.QuestionAnswer> answers) {
        List<QuestionAnswer> result = new ArrayList<>();
        for (pl.altkom.asc.lab.micronaut.poc.serverless.policy.service.api.v1.commands.createoffer.dto.QuestionAnswer answer : answers) {
            if (answer instanceof pl.altkom.asc.lab.micronaut.poc.serverless.policy.service.api.v1.commands.createoffer.dto.TextQuestionAnswer) {
                result.add(new TextQuestionAnswer(answer.getQuestionCode(), (String) answer.getAnswer()));
            } else if (answer instanceof pl.altkom.asc.lab.micronaut.poc.serverless.policy.service.api.v1.commands.createoffer.dto.ChoiceQuestionAnswer) {
                result.add(new ChoiceQuestionAnswer(answer.getQuestionCode(), (String) answer.getAnswer()));
            } else if (answer instanceof pl.altkom.asc.lab.micronaut.poc.serverless.policy.service.api.v1.commands.createoffer.dto.NumericQuestionAnswer) {
